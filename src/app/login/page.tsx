      ...
      <div className="relative z-10 grid w-full max-w-5xl items-center gap-12 lg:grid-cols-2">
        ...
        <div className="hidden flex-col gap-8 text-white lg:flex animate-slide-up">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-white/15 shadow-lg backdrop-blur-md overflow-hidden">
              <svg viewBox="0 0 256 256" fill="none" className="h-full w-full p-1">
                <g transform="translate(28, 28)">
                  <path d="M 65 30 C 60 15, 75 5, 70 -5" stroke="#1E293B" strokeWidth="7" strokeLinecap="round" />
                  <path d="M 100 35 C 95 18, 110 8, 105 -2" stroke="#00C776" strokeWidth="7" strokeLinecap="round" />
                  <path d="M 135 30 C 130 15, 145 5, 140 -5" stroke="#D97706" strokeWidth="7" strokeLinecap="round" />
                  <path d="M 45 60 H 155 L 142 145 C 140 158, 128 168, 114 168 H 86 C 72 168, 60 158, 58 145 Z" fill="#1E293B" />
                  <path d="M 152 75 C 178 75, 178 130, 147 130" stroke="#1E293B" strokeWidth="12" strokeLinecap="round" />
                  <g transform="translate(100, 114)">
                    <path d="M -18 -26 C -38 -15, -38 15, -18 26 C -5 32, 10 18, 0 0 C 10 -18, -5 -32, -18 -26 Z" fill="#00C776" />
                    <path d="M 18 -26 C 38 -15, 38 15, 18 26 C 5 32, -10 18, 0 0 C -10 -18, 5 -32, 18 -26 Z" fill="#D97706" />
                    <path d="M 0 -28 C -8 -10, 8 10, 0 28" stroke="#FFFFFF" strokeWidth="4" strokeLinecap="round" />
                  </g>
                </g>
              </svg>
            </div>
        ...
        <div className="mx-auto w-full max-w-md animate-slide-up">
          <div className="rounded-3xl border border-white/50 bg-white/85 p-8 shadow-2xl shadow-black/20 backdrop-blur-xl sm:p-10">
            ...
            <div className="mb-8 flex flex-col items-center lg:hidden">
              <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#009a5a] to-[#00C776] shadow-lg overflow-hidden">
                <svg viewBox="0 0 256 256" fill="none" className="h-full w-full p-1.5">
                  <g transform="translate(28, 28)">
                    <path d="M 65 30 C 60 15, 75 5, 70 -5" stroke="#FFFFFF" strokeWidth="7" strokeLinecap="round" />
                    <path d="M 100 35 C 95 18, 110 8, 105 -2" stroke="#FFFFFF" strokeWidth="7" strokeLinecap="round" />
                    <path d="M 135 30 C 130 15, 145 5, 140 -5" stroke="#FFFFFF" strokeWidth="7" strokeLinecap="round" />
                    <path d="M 45 60 H 155 L 142 145 C 140 158, 128 168, 114 168 H 86 C 72 168, 60 158, 58 145 Z" fill="#FFFFFF" />
                    <path d="M 152 75 C 178 75, 178 130, 147 130" stroke="#FFFFFF" strokeWidth="12" strokeLinecap="round" />
                    <g transform="translate(100, 114)">
                      <path d="M -18 -26 C -38 -15, -38 15, -18 26 C -5 32, 10 18, 0 0 C 10 -18, -5 -32, -18 -26 Z" fill="#009a5a" />
                      <path d="M 18 -26 C 38 -15, 38 15, 18 26 C 5 32, -10 18, 0 0 C -10 -18, 5 -32, 18 -26 Z" fill="#D97706" />
                      <path d="M 0 -28 C -8 -10, 8 10, 0 28" stroke="#FFFFFF" strokeWidth="4" strokeLinecap="round" />
                    </g>
                  </g>
