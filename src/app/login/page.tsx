      ...
      <div className="relative z-10 grid w-full max-w-5xl items-center gap-12 lg:grid-cols-2">
        ...
        <div className="hidden flex-col gap-8 text-white lg:flex animate-slide-up">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-white/15 text-xl font-extrabold shadow-lg backdrop-blur-md">
              N
            </div>
        ...
        <div className="mx-auto w-full max-w-md animate-slide-up">
          <div className="rounded-3xl border border-white/50 bg-white/85 p-8 shadow-2xl shadow-black/20 backdrop-blur-xl sm:p-10">
            ...
            <div className="mb-8 flex flex-col items-center lg:hidden">
              <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#009a5a] to-[#00C776] text-xl font-extrabold text-white shadow-lg">
                N
              </div>
