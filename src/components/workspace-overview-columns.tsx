              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    {item.assigneeName && (
                      <span className="hidden sm:inline-block px-1.5 py-0.2 rounded text-[9px] font-bold bg-emerald-50 dark:bg-emerald-950/60 text-[#00C776] shrink-0 truncate max-w-[80px]">
                        👤 {item.assigneeName}
                      </span>
                    )}
                  </div>
